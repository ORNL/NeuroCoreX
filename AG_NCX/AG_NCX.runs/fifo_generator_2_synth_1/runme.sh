...
HD_PWD='C:/Users/4v5/Documents/FPGA_Vivado_Restart/AG_NCX/AG_NCX.runs/fifo_generator_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_generator_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_generator_2.tcl
