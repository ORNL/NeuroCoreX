...
#
# Script generated by Vivado on Thu Apr 24 18:48:54 -0400 2025
...
#
# Usage        : fifo_generator_2.sh
#                fifo_generator_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_generator_2.sh [-reset_run]
#                fifo_generator_2.sh [-reset_log]
#                fifo_generator_2.sh [-help]
#
...
#                script (type 'fifo_generator_2.sh -help' for more information).
#
...
xmvhdl_opts="-64bit -messages -logfile .tmp_log"

# set xmvlog compile options
xmvlog_opts="-64bit -messages -logfile .tmp_log"
...
# script info
echo -e "fifo_generator_2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_generator_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_generator_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_generator_2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_generator_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fifo_generator_2.sh [-step]\n\
Usage: fifo_generator_2.sh [-lib_map_path]\n\
Usage: fifo_generator_2.sh [-reset_run]\n\
Usage: fifo_generator_2.sh [-reset_log]\n\
Usage: fifo_generator_2.sh [-keep_index]\n\
