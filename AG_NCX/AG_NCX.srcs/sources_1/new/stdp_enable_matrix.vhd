...
architecture Behavioral of stdp_enable_ram is
    CONSTANT N1 : NATURAL := 95;--19 (14+5)
    CONSTANT N0 : NATURAL := 0;
    type weight_array is array (0 to (N1+1)*(N1+1)-1) of std_logic;
--    signal ram : weight_array:= (others => (others => '0'));

        constant init_weights : weight_array := (
    1   => '0',  -- example value for word 0
